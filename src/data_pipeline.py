...
if __name__ == "__main__":
    import pandas as pd
    stocks = pd.read_csv('C:/Users/Steel/Desktop/Projects/intel-sweep/intel-sweep/src/data/stocks.csv')
    stocks = stocks['Symbol'].dropna().unique().tolist()
    parser = argparse.ArgumentParser(description="Stock Price Forecasting ETL Pipeline")
    parser.add_argument('--fred-dir', type=str, default='C:/Users/Steel/Desktop/Projects/intel-sweep/intel-sweep/src/data/fred_economic_indicators', help="Directory with FRED CSV files")
    parser.add_argument('--yf-dir', type=str, default='C:/Users/Steel/Desktop/Projects/intel-sweep/intel-sweep/src/data/equities', help="Directory with Yahoo Finance CSV files")
